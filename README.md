...
Bash-скрипты для исследования системы Linux.

## Содержание
- [Linux Monitoring v1.0](#linux-monitoring-v10)
  - [Содержание](#содержание)
  - [Общая информация](#общая-информация)
  - [1. Корректность ввода](#1-корректность-ввода)
...
Если параметр - число, то выводится сообщение о некорректном вводе.
...
После вывода значений будет предложено записать данные в файл (**Y/N**).  
...
Улучшение вывода скрипта из части 2.
...
При вводе совпадающих значений выводится сообщение, описывающее проблему, и повторно вызывается скрипт.  

## 4. Конфигурирование визуального оформления вывода для скрипта исследования системы

Изменение скрипта из части 3.  
...
После вывода информации о системе из будет выведена цветовая схема в следующем виде:
```
...
При запуске скрипта с цветовой схемой по умолчанию вывод будет иметь вид:
```
...
Скрипт выведен на экран информацию в виде:
